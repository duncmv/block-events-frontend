...
//   status: string;
//   tags: string;
//   media: File | null;  // Change from FileList to File
// }
...
//           formDataObj.append('media', value);
//         }
...
//           <button
//             type="submit"
//             className="w-full bg-[#8c0327] hover:bg-[#6b0220] text-white rounded-full py-2 px-4"
//             disabled={loading}
//           >
