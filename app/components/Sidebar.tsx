  ...
  return (
    <div className="h-full flex">
      ...
      <div className="flex flex-col h-full w-64 bg-white text-neutral-800 transform -translate-x-full transition-transform duration-300 ease-in-out md:translate-x-0 z-50 p-4 rounded-lg">
        ...
        {/* Move user details higher */}
        <div className="flex flex-col items-center justify-center mt-8 mb-auto">
      ...
      <label
        htmlFor="menu-toggle"
        className="cursor-pointer p-4 block md:hidden absolute top-4 left-4 z-50"
      >
        <svg
